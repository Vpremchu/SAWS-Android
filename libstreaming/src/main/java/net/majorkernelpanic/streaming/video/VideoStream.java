...
public abstract class VideoStream extends MediaStream {
	 ...
	 * You should not call this method from the menu_main thread if you are already streaming.
	 * @throws IOException 
	...
	/**
	 * Opens the camera in a new Looper thread so that the preview callback is not called from the menu_main thread
	 * If an exception is thrown in this Looper thread, we bring it back into the menu_main thread.
